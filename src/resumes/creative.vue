    ...
    <div class="left-column">
      ...
      <div class="hobbies-container">
        ...
        <div class="hobbies-content">
          <a v-for="(hobby, index) in person.hobbies" :key="index" class="hobby-item" :href="hobby.url">
    ...
    <div class="right-column">
      ...
      <div v-if="person.skills" class="skills-section section">
        ...
        <div class="section-content-grid">
          <a v-for="(skill, index) in person.skills" :key="index" class="grid-item" :href="skill.url">
