  ...
  <div id="resume3" class="resume">
    ...
    <div class="resume-content">
      ...
      <div class="contact">
        ...
        <span>;&nbsp;</span>
        <a v-if="person.contact.website" :href="person.contact.website"> {{ person.contact.website }}</a>
        <span v-if="person.contact.website">;&nbsp;</span>
        <a v-if="person.contact.github" :href="contactLinks.github"> {{ contactLinks.github }}</a>
      </div>
    </div>
  </div>
</template>
